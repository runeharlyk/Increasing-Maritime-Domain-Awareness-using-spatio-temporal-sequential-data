...
def load_and_prepare_data(data_path):
    ...
    if 'Timestamp' in df.columns:
        ...
        # Parse with explicit format to avoid warning
        ...
        print("Note: For real training, you should include timestamps in clean.py")
...
def main():
    ...
    print(f"Predictions saved to: predictions.png")
    print("="*60)
