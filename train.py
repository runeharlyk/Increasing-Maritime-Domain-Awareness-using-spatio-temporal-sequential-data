...
for epoch in range(EPOCHS):
    ...
    val_loss, _, _ = evaluate_model(model, val_loader, criterion, output_scaler, DEVICE)
...
test_loss, _, _ = evaluate_model(model, test_loader, criterion, output_scaler, DEVICE)
